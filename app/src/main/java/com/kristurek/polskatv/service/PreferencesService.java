...
public interface PreferencesService {
    ...
    enum KEYS {
        ...
        ACCOUNT_BITRATE_ID("__ACCOUNT_BITRATE_ID__"),
        ACCOUNT_BITRATES("__ACCOUNT_BITRATES__"),
        ACCOUNT_HTTP_CACHING_ID("__ACCOUNT_HTTP_CACHING_ID__"),
        ACCOUNT_HTTP_CACHINGS("__ACCOUNT_HTTP_CACHINGS__"),
        ...
        PLAYER_BUFFER("__PLAYER_BUFFER__"),
        ...
        PLAYER_COMPATIBILITY_MODE("__PLAYER_COMPATIBILITY_MODE__"),
        ...
        APPLICATION_DEBUG_VIEW("__APPLICATION_DEBUG_VIEW__"),
