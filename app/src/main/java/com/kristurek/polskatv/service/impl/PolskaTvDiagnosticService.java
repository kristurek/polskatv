...
public class PolskaTvDiagnosticService implements DiagnosticService {
    ...
    public StringBuilder deviceInformation() {
        ...
        report.append(LINE_SEPARATOR);
        report.append("Bitrates: ");
        report.append(preferencesService.get(ACCOUNT_BITRATES, "None"));
        report.append(LINE_SEPARATOR);
        report.append("Bitrate ID: ");
        report.append(preferencesService.get(ACCOUNT_BITRATE_ID, "None"));
        report.append(LINE_SEPARATOR);
        report.append("HTTP cachings: ");
        report.append(preferencesService.get(ACCOUNT_HTTP_CACHINGS, "None"));
        report.append(LINE_SEPARATOR);
        report.append("HTTP caching ID: ");
        report.append(preferencesService.get(ACCOUNT_HTTP_CACHING_ID, "None"));
        report.append(LINE_SEPARATOR);
